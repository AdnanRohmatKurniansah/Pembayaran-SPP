            ...
            <div class="col-md-10">
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form form-vertical" action="/dashboard/pembayaran/{{ $pembayaran->id }}" method="POST">
                                @method('put')
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-select @error('id_tagihan') is-invalid @enderror" value="{{ old('id_tagihan') }}"  name="id_tagihan">
                                                    @foreach ($tagihans as $tagihan)
                                                      @if(old('id_tagihan', $pembayaran->id_tagihan) == $tagihan->id)
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="jumlah_bayar"
                                                    class="form-control @error('jumlah_bayar') is-invalid @enderror" value="{{ old('jumlah_bayar', $pembayaran->jumlah_bayar) }}" name="jumlah_bayar"
